$(document).ready(function() {
  ...
  $(".brand__logo").on('click', function(event) {
    ...
    if ($(this).attr("data-brand") == 'hyundai') {
      $("#dc_hyundai").removeClass("hidden");
    }
    if ($(this).attr("data-brand") == 'iat') {
      $("#dc_iat").removeClass("hidden");
    }
