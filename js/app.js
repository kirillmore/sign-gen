$(document).ready(function()
{
  ...
  //template
    ...
    template_hyundai_parnas='<table style="font-size:9px;font-family:\'Hyundai Sans Text\',\'Hyundai Sans Text Office\',Arial;" border="0" cellpadding="0" cellspacing="0"><tr><td><img src="https://kirillmore.ru/temp/iat/images/blank.png" width="370" height="34"></td><tr><tr><td><img src="'+url+'logo_hyundai.png" width="207" height="34" style="width:207px;height:34px;margin-bottom:15px;"></td></tr><tr><td style="font-family:\'Hyundai Sans Head Medium\',\'Hyundai Sans Head Office Medium\',Arial;">{фамилия} {имя}<br>{отдел}<br></td></tr><tr><td>{должность}<br>T {tel}, {доб.}<br>М {mob}<br><a href="mailto:{email}">{email}</a>&nbsp;&nbsp;<a href="//hyundai-parnas.ru">www.hyundai-parnas.ru</a><br><br></td></tr><tr><td style="font-family:\'Hyundai Sans Head Medium\',\'Hyundai Sans Head Office Medium\',Arial;font-size:12px;">ИАТ Парнас<br></td></tr><tr><td style="font-family:\'Hyundai Sans Head Medium\',\'Hyundai Sans Head Office Medium\',Arial;font-size:9px;">Официальный дилер Hyundai</td></tr><tr><td><img src="https://kirillmore.ru/temp/iat/images/blank.png" width="370" height="16"></td><tr><tr><td><a href="https://hyundai-parnas.ru/NewCreta"><img src="'+url+'banner_creta.png" width="370" height="93" style="width:370px;"></a></td></tr></table>';
