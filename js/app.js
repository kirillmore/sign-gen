$(document).ready(function()
{
  ...
  //template
    ...
    template_hyundai_parnas='<table style="font-size:9px;font-family:\'Hyundai Sans Text\';"><tr><td><img src="'+url+'logo_hyundai.png" style="width:207px;height:34px;margin-top:34px;margin-bottom:15px;"></td></tr><tr><td><span style="font-family:\'Hyundai Sans Head Medium\';">{фамилия} {имя}<br>{отдел}<br></span>{должность}<br>T {tel}, {доб.}<br>М {mob}<br><a href="mailto:{email}">{email}</a>&nbsp;&nbsp;<a href="//hyundai-parnas.ru">www.hyundai-parnas.ru</a><br><br><span style="font-family:\'Hyundai Sans Head Medium\';font-size:12px;">ИАТ Парнас<br></span><span style="font-family:\'Hyundai Sans Head Medium\';font-size:9px;">Официальный дилер Hyundai</span></td></tr><tr><td><a href="https://hyundai-parnas.ru/NewCreta"><img src="'+url+'banner_creta.png" style="margin-top:16px;width:370px;"></a></td></tr></table>';
