$(document).ready(function()
{
  ...
  //template
    ...
    template_hyundai_parnas='<table style="font-size:10px;font-family:\'Hyundai Sans Text Office\';"><tr><td><img src="'+url+'logo_hyundai.png" style="width:207px;height:34px;margin-top:34px;margin-bottom:34px;"></td></tr><tr><td><b style="font-family:\'Hyundai Sans Head Office\';">{фамилия} {имя}</b><br><b>{отдел}</b><br><b>{должность}</b><br>T {tel}, {доб.}<br>М {mob}<br><a href="mailto:{email}">{email}</a>&nbsp;&nbsp;<a href="//hyundai-parnas.ru">www.hyundai-parnas.ru</a><br><br><b>ИАТ Парнас</b><br><b>Официальный дилер Hyundai</b></td></tr><tr><td><a href="https://hyundai-parnas.ru/NewCreta"><img src="'+url+'banner_creta.png" style="margin-top:16px;width:440px;"></a></td></tr></table>';
